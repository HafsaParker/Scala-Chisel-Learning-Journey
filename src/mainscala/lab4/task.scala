...
trait CConfig {     
val WLEN = 32             
val ALUOP_SIG_LEN = 4    // ALU operation control signal width
}
class AALUIO extends Bundle with CConfig {
...
class task extends Module with CConfig {
val io = IO ( new AALUIO )
